      ...
      <div className="content-tabs">
        ...
        >
          ...
          <DataGrid id='sample'
                    ...
                    <Column dataField='ProductID' caption='Product ID' dataType ='string'><ValidationRule type="required" /></Column>
                    <Column dataField='StartInventory' caption='Starting Inventory' dataType='int'><ValidationRule type="required" /></Column>
                    <Column dataField='ReceivedInventory' caption='Inventory Received' dataType='int'><ValidationRule type="required" /></Column>
                    <Column dataField='ShippedInventory' caption='Inventory Shipped' dataType='int'><ValidationRule type="required" /></Column>
                    <Column dataField='OnHandInventory' caption='Inventory On Hand' dataType='int'><ValidationRule type="required" /></Column>
    
                </DataGrid>
                <br></br>
                <div>
                  
                    <Button><b>View Inventory Summary</b></Button>
                    <Button><b>Clear</b></Button>
                </div>
            </div>
      </div>
