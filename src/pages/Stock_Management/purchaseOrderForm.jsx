      ...
      {showList ? (
        ...
        <div className={"content-block"}>
          ...
          <Card style={{ width: "100%" }}>
            <Card.Body>
              <Card.Title>
                <h6>Purchase Order Header</h6>
              </Card.Title>
              <Card.Text>
                We can place the purchase order here. User should be able to add
                multiple orders for the same supplier. therefore we have to use
                a datagrid with this form
              </Card.Text>
          ...
          <Card style={{ width: "100%" }}>
            <Card.Body>
              ...
              <Card.Text>
                You can purchase multiple products at the same time from the
                same supplier here.{" "}
              </Card.Text>
              <br />
              <DataGrid
              ...
              >
                ...
                <Column dataField="Rate" caption="Rate" dataType="int">
                  <ValidationRule type="required" />
                </Column>
                <Column
                  dataField="UnitPrice"
