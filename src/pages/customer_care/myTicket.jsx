...
export default function MyTicket() {
    const myDataSource = [{ AutoID: 1, TicketID: '1005', TktCategory: 'Request an Order Summary', DeptCategory:'Product Retailing Department', date: '21/11/2022', Status:'Processing'},
        ...
        <div className= {'content-block'}>
            ...
            <DataGrid classNAme={'dx-card wide-card'}
                ...
                <div>
                        ...
                        <Button style={buttonStyle}><b>Submit a Ticket</b></Button>
                </div>
        </div>
    </React.Fragment>
)
