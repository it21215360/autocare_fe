...
const FAQ_PDF_URL =
  "http://localhost:3000/#/customer_care/freaquentQuestion/faq_pdf.pdf";
...
function FreaquentQuestionPage({ faq, index }) {
  const [faqs, setfaqs] = useState([
    ...
    },
    {
      ...
      answer:
        "The amount of pressure required by a tire is determined by its kind and the vehicle. The recommended air pressure is listed on the door jamb, the sidewall of the tires, or in your owner's handbook. Too much pressure might make manoeuvring your car difficult, while too little pressure can result in a blowout. You can always consult with a product expert to decide which pressure levels are best for you.",
      open: false,
    },
    {
